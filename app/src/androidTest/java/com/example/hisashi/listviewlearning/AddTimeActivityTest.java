...
//        this.timeText = (EditText) getActivity().findViewById(R.id.time_view);
...
//
//        View view = this.getActivity().findViewById(R.id.time_view);
...
//
//        final EditText timeText = (EditText) getActivity().findViewById(R.id.time_view);
...
//
//        EditText sentTimeText = (EditText) getActivity().findViewById(R.id.time_view);
